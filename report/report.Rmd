...
```{r sample-fig4, echo=FALSE, fig.align="center", out.width = "75%", out.height = "25%", fig.cap="Neural Network example"}
...
What this tells us is that if a random person were to guess that every picture was a picture of pneumonia, that they would be correct 76% of the time. So when I build out my models, I will be looking for a model that is able to achieve better than 76% accuracy to say it is an improvement over a baseline random guessing model. 
...
```{r sample-fig5, echo=FALSE, fig.align="center", out.width = "75%", out.height = "25%", fig.cap="Model 1"}
knitr::include_graphics("images/model1.png")
```


```{r sample-fig6, echo=FALSE, fig.align="center", out.width = "50%", out.height = "25%", fig.cap="Model 1 Accuracy Scores"}
...
```{r sample-fig7, echo=FALSE, fig.align="center", out.width = "75%", out.height = "25%", fig.cap="Model 2"}
knitr::include_graphics("images/model2.png")
```

```{r sample-fig8, echo=FALSE, fig.align="center", out.width = "75%", out.height = "25%", fig.cap="Model 2 Accuracy Scores"}
...
```{r sample-fig9, echo=FALSE, fig.align="center", out.width = "75%", out.height = "25%", fig.cap="Model 3"}
knitr::include_graphics("images/model3.png")
```


```{r sample-fig10, echo=FALSE, fig.align="center", out.width = "75%", out.height = "25%", fig.cap="Model 3 Accuracy Scores"}
...
```{r sample-fig11, echo=FALSE, fig.align="center", out.width = "75%", out.height = "25%", fig.cap="Confusion Matrix"}
